...
# ---------------------------------------------------------------------------
# Embutir SQL com segurança numa string tripla Python. Usado pelo motor M2
# (codegen_pycodegen); os templates de geração agora são DADOS governáveis
# (codegen_techniques / codegen_patterns), não mais strings fixas aqui.
# ---------------------------------------------------------------------------
